...
plt.savefig(f'/hpcfs/bes/mlgpu/hoseinkk/MLTracking/otherparticles/pppipi/{modelname}/results/{t}\
  Loss_function_for_the_last_{EpochNum}_epochs_(tanh_activation_at_last_layer).png', bbox_inches='tight')
...
plt.savefig(f'/hpcfs/bes/mlgpu/hoseinkk/MLTracking/otherparticles/pppipi/{modelname}/results/{t}\
  eff-pur_for_the_last_{EpochNum}_epochs_(tanh_activation_at_last_layer).png', bbox_inches='tight')
